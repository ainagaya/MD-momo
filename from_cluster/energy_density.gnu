...
plot data_file using 1:2:3 with yerrorbars title 'Kinetic', \
     data_file using 1:4:5 with yerrorbars title 'Potential', \
     data_file using 1:6:7 with yerrorbars title 'Total'
