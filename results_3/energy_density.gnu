...
set xlabel "Density"      # Etiqueta de l'eix X
...
plot data_file using 1:3:4 with yerrorbars title 'Kinetic', \
     data_file using 1:5:6 with yerrorbars title 'Potential', \
     data_file using 1:7:8 with yerrorbars title 'Total'
     
     
set output "preassure.png"

plot data_file using 1:9:10 with yerrorbars
