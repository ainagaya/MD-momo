...
plot file i 4 using 1:2 t 'Potential energy', file i 4 using 1:3 t 'Kinetic energy', file i 4 using 1:4 t 'Total energy'
...
plot file i 2 using 1:5 t 'Momentum'

set output "momentum_verlet_3.png"

set title "\Delta t' = 10^{-7}"

plot file i 4 using 1:5 t 'Mometum'
