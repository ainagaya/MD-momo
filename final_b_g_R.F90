...
!	real(8), parameter :: k_b = 1.380649e-23
	...
	real(8), dimension(N, 3) :: r, r_ini, vel, vel_ini, r_out, F
	integer :: step, i, rho_index, Nsteps
	real(8) :: pot, K_energy, L, cutoff, M, a, Temp, dt, absV, p, tini, tfin, rho, sigma_gaussian
...
Function preassure(N, r, f, rho, T, L)
	Implicit none
	integer :: N, i, j, step
	real(8) :: sum, preassure, T, L, rho
